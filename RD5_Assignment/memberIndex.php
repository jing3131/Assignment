        ...
        <form action="" method="post">
            <table width="300" style="border:5px #DEB887 solid">
                ...
                <tr>
                    ...
                    　<td align="center"><button class="btn btn-outline-dark" type="submit" name="depositbtn" id="depositbtn">存款</button> </td>
                    　 </tr>
                <tr>
                    　<td align="center">提款：</td>
                    　<td align="center"><button type="submit" class="btn btn-outline-dark" name="withdrawbtn" id="withdrawbtn">提款</button></td>
                    　 </tr>
                <tr>
                    　<td align="center">查詢餘額：</td>
                ...
                <tr>
                    　<td align="center">查詢明細：</td>
                    　<td align="center"><button type="submit" class="btn btn-outline-dark" name="detailbtn" id="detailbtn">查詢明細</button></td>
                    　 </tr>
